...
namespace FairyWay
{
    ...
    {
        public override Type BaseCLRType => typeof(System.Runtime.CompilerServices.IAsyncStateMachine); //这是你想继承的那个类
        ...
        private class Adaptor : System.Runtime.CompilerServices.IAsyncStateMachine, CrossBindingAdaptorType
        {
            ILTypeInstance instance;
