...
namespace SteamClient
{
    public static unsafe class ILRuntimeHelper
    {
        ...
        public static void RegisterDelegate(AppDomain appDomain)
        {
            ...
            appDomain.DelegateManager.RegisterFunctionDelegate<SteamClient.ObjectBaseAdapter.Adapter, System.Boolean>();
            appDomain.DelegateManager.RegisterMethodDelegate<FairyGUI.GObject, System.Object>();
            appDomain.DelegateManager.RegisterFunctionDelegate<SteamClient.ObjectBaseAdapter.Adapter, SteamClient.ObjectBaseAdapter.Adapter, System.Int32>();
            ...
            appDomain.DelegateManager.RegisterFunctionDelegate<SteamClient.IMessageAdapter.Adaptor>();
            ...
            appDomain.DelegateManager.RegisterFunctionDelegate<SteamClient.IMessageAdapter.Adaptor, System.Int32>();
            ...
            appDomain.DelegateManager.RegisterFunctionDelegate<SteamClient.IMessageAdapter.Adaptor, System.Boolean>();
            appDomain.DelegateManager.RegisterFunctionDelegate<SteamClient.IMessageAdapter.Adaptor, SteamClient.IMessageAdapter.Adaptor, System.Int32>();
            appDomain.DelegateManager.RegisterFunctionDelegate<ILRuntime.Runtime.Intepreter.ILTypeInstance, ILRuntime.Runtime.Intepreter.ILTypeInstance, System.Int32>();
            appDomain.DelegateManager.RegisterFunctionDelegate<System.Int64, System.Int64, System.Int32>();
            appDomain.DelegateManager.RegisterFunctionDelegate<SteamClient.IMessageAdapter.Adaptor, System.Int64>();
            ...
            appDomain.DelegateManager.RegisterDelegateConvertor<System.Comparison<SteamClient.IMessageAdapter.Adaptor>>((act) =>
            {
                return new System.Comparison<SteamClient.IMessageAdapter.Adaptor>((x, y) =>
                {
                    return ((Func<SteamClient.IMessageAdapter.Adaptor, SteamClient.IMessageAdapter.Adaptor, System.Int32>)act)(x, y);
                });
            });
            ...
            appDomain.DelegateManager.RegisterDelegateConvertor<System.Predicate<SteamClient.IMessageAdapter.Adaptor>>((act) =>
            {
                return new System.Predicate<SteamClient.IMessageAdapter.Adaptor>((obj) =>
                {
                    return ((Func<SteamClient.IMessageAdapter.Adaptor, System.Boolean>)act)(obj);
                });
            });

            appDomain.DelegateManager.RegisterDelegateConvertor<System.Comparison<SteamClient.ObjectBaseAdapter.Adapter>>((act) =>
            {
                return new System.Comparison<SteamClient.ObjectBaseAdapter.Adapter>((x, y) =>
                {
                    return ((Func<SteamClient.ObjectBaseAdapter.Adapter, SteamClient.ObjectBaseAdapter.Adapter, System.Int32>)act)(x, y);
                });
            });
            ...
            appDomain.DelegateManager.RegisterDelegateConvertor<System.Predicate<SteamClient.ObjectBaseAdapter.Adapter>>((act) =>
            {
                return new System.Predicate<SteamClient.ObjectBaseAdapter.Adapter>((obj) =>
                {
                    return ((Func<SteamClient.ObjectBaseAdapter.Adapter, System.Boolean>)act)(obj);
                });
            });
        }
