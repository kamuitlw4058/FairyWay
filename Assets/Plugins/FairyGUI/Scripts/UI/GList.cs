...
namespace FairyGUI
{
    ...
    public class GList : GComponent
    {
        ...
        {
            Debug.Log($"Select SetSelectionOnEvent:{item.name} selectionMode:{selectionMode}");
        ...
        {
            Debug.Log($"Select UpdateSelectionController:{index}");
